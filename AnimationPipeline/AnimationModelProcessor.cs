...
namespace AnimationPipeline
{
    ...
    /// </summary>
    [ContentProcessor(DisplayName = "Animation Processor - XnaAux")]
    public class AnimationModelProcessor : ModelProcessor//ContentProcessor<NodeContent, ModelContent>
    {
        /// <summary>
        ...
        public override ModelContent Process(NodeContent input, ContentProcessorContext context)
        {
            ...
            //model = modelProcessor.Process(input, context);
