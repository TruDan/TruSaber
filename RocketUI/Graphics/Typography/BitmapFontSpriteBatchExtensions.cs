...
namespace RocketUI.Graphics.Typography
{
    public static class BitmapFontSpriteBatchExtensions
	{
		...
		//public static void DrawString(this SpriteBatch sb, IFont font, string text, Vector2 position, Color color, FontStyle style, float rotation, Vector2 origin, Vector2 scale, SpriteEffects effects = SpriteEffects.None, float layerDepth = 0f, float opacity = 1f)
		//{
		...
		//			{
		//				styleColor = Color.GetColor(formatChar);
		//			}
