...
namespace TruSaber.Scenes
{
    ...
    public abstract class GuiSceneBase : Scene
    {
        ...
        protected GuiSceneBase()
        {
            ...
            GuiScreen.Transform.LocalPosition = new Vector3(-(ScreenSize.X /2f), ScreenSize.Y,-3f);
            GuiScreen.Transform.LocalScale = new Vector3(ScreenSize.X / GuiManager.ScaledResolution.ScaledWidth, ScreenSize.Y / GuiManager.ScaledResolution.ScaledHeight, 1f);
            GuiScreen.Transform.LocalRotation = Quaternion.CreateFromYawPitchRoll(0f, 180f.ToRadians(), 0f);
        ...
        {
            GuiScreen.Transform.LocalPosition = new Vector3(-(ScreenSize.X /2f), ScreenSize.Y,-3f);
            GuiScreen.Transform.LocalScale = new Vector3((float)ScreenSize.X / GuiManager.ScaledResolution.ScaledWidth, (float)ScreenSize.Y / GuiManager.ScaledResolution.ScaledHeight, 1f);
        }
