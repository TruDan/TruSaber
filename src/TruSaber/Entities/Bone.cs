...
namespace TruSaber
{
    ...
    public class Bone
    {
        ...
        public override string ToString() => $"Bone{Name}";
        ...
        public void SetRelativeTransform(Matrix m)
        {
            if (m.Decompose(out var mScale, out var mRotation, out var mTranslation))
            {
                Scale = mScale;
                Rotation = mRotation;
